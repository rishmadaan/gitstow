...
| View a repo's uncommitted changes | `gitstow diff owner/repo` (add `--staged` for staged changes only; `--json` lists changed files; clean repo prints "no local changes") |
